...
*---------------------------------------------------------------*;
%include "C:\Users\Jack\Desktop\SAS_BOOK_cdisc_2nd_edition\sas_code\common.sas";


proc import 
    datafile="C:\Users\Jack\Desktop\SAS_BOOK_cdisc_2nd_edition\sas_code\SDTM_metadata\SDTM_METADATA.xls"
    out=formatdata 
    dbms=excelcs 
    replace; 
    sheet="CODELISTS";
